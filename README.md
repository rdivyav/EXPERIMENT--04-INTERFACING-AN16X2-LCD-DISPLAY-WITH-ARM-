...
MX_GPIO_Init();
  Lcd_PortType ports[]={GPIOA,GPIOA,GPIOA,GPIOA};
  	...
  	Lcd_cursor(&lcd,1,0);
  	Lcd_string(&lcd,"Divya R.V");
```
## Output screen shots of proteus  :
 ![Screenshot 2024-09-19 131941](https://github.com/user-attachments/assets/7b5bce3f-dbf8-44cb-8f5b-ff9e39b9ffa5)
 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![image](https://github.com/user-attachments/assets/04ff4aa6-43ac-4f8f-b46f-e9a700997272)
